...
# dataFile = './scheduling_prj_list/%s/data/排产项目数据.xlsx'%(prj_name)# 排产数据文件
# resultFile = './scheduling_prj_list/%s/data/智能排产结果.xlsx'%prj_name # 排产结果文件
...
##################################################################################本地调试-注释开始
prj_name = "创元泡罩车间试点"                         # 排产项目名称
dataFile = './data/泡罩专属-勿删-算法数据导出.xlsx'   # 排产数据文件
resultFile = './data/智能排产结果.xlsx'               # 排产结果文件
